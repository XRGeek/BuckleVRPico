...
namespace VRStandardAssets.ShootingGallery
{
    ...
    public class ShootingGalleryGun : MonoBehaviour
    {
        ...
        private void Update()
        {
			//Quaternion rotation= OVRInput.GetLocalControllerRotation(OVRInput.GetActiveController());
		...
		public Ray GetGunray(){
			return new Ray (m_GunEnd.position,m_GunEnd.forward);
		}
